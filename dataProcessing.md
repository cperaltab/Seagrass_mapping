...
Imported all data points (93 in total) to GoogleEarth Pro and check accuracy of points and benthic habitat verification (only used seagrass, sand and hardbottom type), no hard corals were used in the firts clasification run. 
